...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        ?>
        <link rel="stylesheet" href="<?php echo $this->webroot; ?>css/css/colorpicker.css" type="text/css" />
        ...
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/js/colorpicker.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/js/eye.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/js/utils.js"></script>
        <script type="text/javascript" src="<?php echo $this->webroot; ?>js/js/layout.js?ver=1.0.2"></script>
    </head>
