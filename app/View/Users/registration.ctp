...
<?php echo $this->Form->create('User',array('action' => 'registration'));?>
	...
	<div id="form-holder" class="form-margin">
		...
		<div id="textbox"><?php echo $this->Form->input('first_name',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'First Name..')); ?></div>
        <div class="asterisk">(*)</div>
	</div>
	
	<div id="form-holder">
		<div id="label">Last Name :</div>
		<div id="textbox"><?php echo $this->Form->input('last_name',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'Last Name..')); ?></div>
        <div class="asterisk">(*)</div>
	</div>
    
    <!--<div id="form-holder">
		<div id="label">User Name :</div>
		<div id="textbox"><?php //echo $this->Form->input('username',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'User Name..')); ?></div>
        <div class="asterisk">(*)</div>
	</div>-->
    
    <div id="form-holder">
		<div id="label">Email Address :</div>
		<div id="textbox"><?php echo $this->Form->input('email_address',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'Enter a valid email address..')); ?><?php echo $this->Form->input('user_type',array('type'=>'hidden','value'=>'admin')); ?><?php echo $this->Form->input('User.created_by',array('type'=>'hidden','value'=>0)); ?> <?php echo $this->Form->input('User.status',array('type'=>'hidden','value'=>0)); ?></div>
        <div class="asterisk">(*)</div>
	</div>
    
    <div id="form-holder">
		<div id="label">Password :</div>
		<div id="textbox"><?php echo $this->Form->input('password',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'Password..')); ?></div>
        <div class="asterisk">(*)</div>
	</div>
	
	<div id="form-holder">
		<div id="label">Address :</div>
		<div id="textbox"><?php echo $this->Form->input('address',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'Enter address here...','type'=>'textarea')); ?></div>
        <div class="asterisk">(*)</div>
	</div>
    
    <div id="form-holder">
		<div id="label">Location :</div>
		<div id="textbox"><?php echo $this->Form->input("location",array('type'=>'select',"options"=>array($location),'empty'=>'Select Timezone','div'=>false,'label'=>false,'style'=>'width:330px'));?></div>
        <div class="asterisk">(*)</div>
	</div>
	
	<div id="form-holder">
		<div id="label">Hourly Rate($):</div>
		<div id="textbox"><?php echo $this->Form->input('hourly_rate',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'Hourly Rate..','type'=>'text')); ?></div>
        <div class="asterisk">(*)</div>
	</div>
