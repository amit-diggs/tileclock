...
?>
	<div id="heading">Edit Employee</div>
    ...
    <!--<div id="form-holder">
		...
		<div id="textbox"><?php echo $this->Form->input('User.username',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'User Name..')); ?></div>
        <div class="asterisk">(*)</div>
	</div>-->
    
    <div id="form-holder">
		<div id="label">Email Address :</div>
		<div id="textbox"><?php echo $this->Form->input('User.email_address',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'Enter a valid email address..')); ?></div>
        <div class="asterisk">(*)</div>
	</div>
    ...
    <div id="form-holder">
		...
		<div id="textbox">
			<?php echo $this->Form->input("User.location",array('type'=>'select',"options"=>array($location),'empty'=>'Select Timezone','div'=>false,'label'=>false,'style'=>'width:330px'));?>
        </div>
        <div class="asterisk">(*)</div>
	</div>
	...
	<div id="form-holder">
		...
		<div id="textbox">
			<?php echo $this->Form->input('User.hourly_rate',array('label'=>false,'div'=>false,'size'=>50,'placeholder'=>'Hourly Rate..','type'=>'text')); ?>
        </div>
        <div class="asterisk">(*)</div>
	</div>
