...
(function(c, v) {
    ...
    c.fn.clock = function(a) {
        ...
        return this.each(function() {
            ...
            a = a || {};
            a.timestamp = a.timestamp || "systime";
            systimestamp = new Date;
            systimestamp = systimestamp.getTime();
            a.sysdiff = 0;
            "systime" != a.timestamp && (mytimestamp = new Date(a.timestamp), a.sysdiff = a.timestamp - systimestamp);
            a.langSet = a.langSet || "en";
            a.format = a.format || ("en" != a.langSet ? "24" : "12");
            a.calendar = a.calendar || "true";
            a.seconds = a.seconds || "true";
            ...
            var l = function(a) {
                ...
                if ("destroy" == b)
                    ...
                    c(k).html(r + "<span class='clocktime'>" + d + ":" + m + ("true" == a.seconds ? ":" + n : "") + q + "</span>");
...
// This must be a hyperlink
    ...
    $.clock.locale = {"pt": {"weekdays": ["Domingo", "Segunda-feira", "Terra-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sabado"], "months": ["Janeiro", "Fevereiro", "Marao", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "October", "Novembro", "Dezembro"]}};
